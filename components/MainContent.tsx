      ...
      <div className="max-w-5xl mx-auto px-4 py-12 md:py-20">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
          <div className="text-center md:text-left max-w-xl">
            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight text-balance antialiased">
              <span className="block text-rendering-optimizeLegibility">{t('title.the')}</span>
              <span className="block text-rendering-optimizeLegibility">{t('title.simple')}</span>
              <span className="block text-rendering-optimizeLegibility">{t('title.architect')}</span>
            </h1>
