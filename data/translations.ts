export const translations = {
  ...
  subtitle: {
    en: "Simple laws for sustainable architectures.",
    it: "Leggi semplici per architetture sostenibili.",
  },
  law: {
    en: "LAW",
    it: "LEGGE",
  ...
  laws: {
    ...
    // To add a new law, copy the structure above and add a new entry with a new ID
  },
}
